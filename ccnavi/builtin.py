...
ルールファイルが壊れている、あるいはまだ無いときに拒否にすると、
...
限る。ここを開けると、`echo x > .ccnavi/common/rules.yml` でルールを壊し、
壊れた結果として緩んだ既定に戻る、という順路ができてしまう。
...
# 返す理由に載せる出所。既定を使っているとき、当てているルールは読めなかった
