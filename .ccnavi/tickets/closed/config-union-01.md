...
rationale: '親チケット config-union の決定一覧を、設計書 §25 の改版として `wip/design/config-union.md`
...
ccnavi_approved:
  ...
  source_path: C:\Users\taniyama\Desktop\git\ccnavi\.claude\worktrees\config-union\wip\tickets\todo\config-union-01.md
---
