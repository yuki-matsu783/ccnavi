...
rationale: '設計への敵対的レビューが見つけた穴のうち、判定を厳しくする側の 5 件を塞ぐ。どれも
...
ccnavi_approved:
  ...
  source_path: C:\Users\taniyama\Desktop\git\ccnavi\.claude\worktrees\config-union\wip\tickets\todo\config-union-07.md
---
