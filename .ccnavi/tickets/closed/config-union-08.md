...
rationale: '`wip/design/config-union.md`（レビュー済みの設計）と、フェーズ 3 で入った実装を、文書に写す。
...
ccnavi_approved:
  approved_at: 2026-09-13T05:14:03+0900
  source_tree: config-union
  source_path: C:\Users\taniyama\Desktop\git\ccnavi\.claude\worktrees\config-union\wip\tickets\todo\config-union-08.md
---
